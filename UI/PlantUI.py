...
from API.Plant import PlantAPI

class PlantRecognitionWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI()
    ...
    def initUI(self):
        ...
        self.animalNameLabel = QLabel('植物名称', self)
        ...
        self.animalInfoLabel = QLabel('植物信息', self)
